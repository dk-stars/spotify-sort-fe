      ...
      <div className="login-page__shell">
        <section className="login-card login-card--intro">
          ...
          <div className="login-card__headline-block">
            ...
            <p className="login-card__subtitle">
              Spotify Sort scans public & private playlists, enriches tracks and proposes playlist creation and organization.
            </p>
          </div>
          ...
          <div className="login-card__feature-grid">
            ...
            <article className="login-card__feature">
              <span className="login-card__feature-label">Clean</span>
              <p>Now you can finally unpack your old playlists and make them more structured.</p>
            </article>
            <article className="login-card__feature">
              <span className="login-card__feature-label">Flexible</span>
              <p>You can undo all changes whenever you like.</p>
            </article>
          </div>
        </section>
        ...
        <section className="login-card login-card--action">
          ...
          <p className="login-card__action-copy">
            Sign in to load your Spotify playlists, and generate a proposal from your own library.
          </p>
          <button className="btn btn--primary btn--large login-card__button" onClick={handleLogin}>
            Connect with Spotify
          </button>
          <p className="login-card__legal-note">
            Non-commercial project by sdklab studio. Uses the Spotify Web API and Last.fm API.
          </p>
        </section>
      </div>
